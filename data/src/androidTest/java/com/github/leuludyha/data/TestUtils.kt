...
object TestUtils {
    ...
    val author1 = AuthorEntity("author1", "wiki1", "Author1", birthDate = "1", "person")
    val author2 = AuthorEntity("author2", null, "Author2", birthDate = "2,", null)
    val author3 = AuthorEntity("author3", null, "Author3", birthDate = "3", null)
    val author4 = AuthorEntity("author4", null, "Author4", birthDate = "4", null)
    val edition1 = EditionEntity("edition1", "MyEdition1")
    val edition2 = EditionEntity("edition2", "MyEdition2")
    val edition3 = EditionEntity("edition3", "MyEdition3")
    val edition4 = EditionEntity("edition4", "MyEdition4")
