...
object TestUtils {
    ...
    val author1 = AuthorEntity("author1", "wiki1", "Author1", birthDate = "1", deathDate = null)
    val author2 = AuthorEntity("author2", null, "Author2", birthDate = "2,", deathDate = null)
    val author3 = AuthorEntity("author3", null, "Author3", birthDate = "3", deathDate = null)
    val author4 = AuthorEntity("author4", null, "Author4", birthDate = "4", deathDate = null)
